	...
	if (curMapName=="sp_a3_transition01")
	{
		...
		*/
		...
		SceneTable["-3120_03"] <-
		{
			...
			fires=
				[
					{entity="@glados",input="runscriptcode",parameter="sp_a3_transition01_peck()",delay=2.20,fireatstart=true}
				]
		}
		//Glados: Ow!
		SceneTable["-3120_04"] <-
		{
			...
			fires=
				[
					{entity="@glados",input="runscriptcode",parameter="sp_a3_transition01_peck()",delay=0,fireatstart=true}
				]
		}
		//Glados: Ow!
		SceneTable["-3120_05"] <-
		{
			...
			fires=
				[
					{entity="@glados",input="runscriptcode",parameter="sp_a3_transition01_peck_alt()",delay=0,fireatstart=true}
				]
		}
		//Glados: Ow!
		SceneTable["-3120_06"] <-
...
function sp_a3_transition01_peck_alt()
{
	if (!sp_a3_transition01_bird_flew_away)
	{
		EntFire("bird","SetAnimation","nest_peckALT",0.0)
		EntFire("@glados","runscriptcode","sp_a3_transition01_birdidle()",1.05)
	}	
}
